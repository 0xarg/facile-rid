...
export function FinalCTA() {
  ...
  return (
    <section className="relative overflow-hidden border-t border-black/[0.04] bg-[#ffffff]">
      {/* radial glow */}
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-24 size-[600px] -translate-x-1/2 rounded-full bg-[#e5242a]/[0.06] blur-[100px]"
      />
      <div className="relative mx-auto flex w-full max-w-[760px] flex-col items-center px-5 py-24 text-center sm:px-8 lg:py-28">
        ...
        <h2 className="font-display mt-12 text-balance text-4xl font-extrabold leading-[1.05] tracking-tight text-[#0a0a0a] sm:text-5xl lg:text-6xl">
          Your last business card.
        </h2>
        <p className="mt-5 max-w-md text-pretty text-base text-[#0a0a0a]/55">
        ...
        <p className="mt-7 text-xs text-[#0a0a0a]/30">
