...
function IconChip({ children }: { children: ReactNode }) {
  return (
    <span className="flex size-11 items-center justify-center rounded-2xl border border-[#e5242a]/15 bg-[#e5242a]/[0.08]">
      {children}
    </span>
  );
}
        ...
        <Stagger className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <BentoCard tag="Speed">
            <div className="flex flex-1 flex-col items-center justify-center gap-3 py-2">
              <ActivityRing size={128} strokeWidth={11} gap={5} value="0.8s" label="To open" />
          ...
          <BentoCard tag="The profile" className="sm:col-span-2 lg:col-span-2">
            <div className="flex flex-1 items-start gap-5">
              ...
              {/* phone mockup */}
              <div className="hidden h-[140px] w-20 shrink-0 rounded-[14px] border border-black/10 bg-[#f6f5f2] p-[7px] sm:flex sm:flex-col sm:gap-[3px]">
                ...
                {ANALYTICS_BARS.map((h, i) => (
                  <div
                    ...
                    style={{
                      ...
                      backgroundImage:
                        i >= 9
                          ? "linear-gradient(to bottom, #e5242a, rgba(229, 36, 42,0.4))"
                          : undefined,
