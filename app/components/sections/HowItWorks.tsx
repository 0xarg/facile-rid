            ...
            <StaggerItem key={step.title}>
              <div className="group flex flex-col">
                <div className="relative aspect-square w-full overflow-hidden rounded-3xl bg-[#f3f4f6] transition-transform duration-300 ease-out group-hover:-translate-y-1">
                  ...
                  />
                  <span className="absolute left-4 top-4 inline-flex size-9 items-center justify-center rounded-full border border-black/15 bg-black/55 font-display text-sm font-semibold text-[#0a0a0a] backdrop-blur-md">
                    {i + 1}
                  </span>
                </div>
