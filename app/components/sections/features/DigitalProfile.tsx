...
const BRAND_GRADIENT =
  "linear-gradient(135deg, #ff8a8d 0%, #e5242a 100%)";
...
function ProfileCardMock() {
  return (
    ...
    >
      <div className="w-[260px] rounded-[20px] bg-[#f6f5f2] p-6 shadow-[0_30px_60px_-24px_rgba(0,0,0,0.45)]">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <p className="text-[15px] font-bold text-[#0a0a0a]">Alex Morgan</p>
        ...
        <div className="mt-3.5 flex flex-col gap-2.5">
          {["linkedin.com/alexmorgan", "dribbble.com/alex", "calendly.com/alex"].map(
            (l) => (
              <div
                key={l}
                className="rounded-lg bg-[#ececea] px-3 py-2 text-[11px] text-[#777]"
              >
                {l}
              </div>
            )
  ...
  return (
    <div className="flex h-full w-full items-center justify-center rounded-2xl bg-gradient-to-br from-[#eceae5] to-[#dedcd6] p-6 ring-1 ring-black/[0.04]">
      <div className="w-[300px]">
        <div className="flex items-center gap-2.5 rounded-xl bg-[#f6f5f2] px-3.5 py-2.5">
          <span className="size-2 shrink-0 rounded bg-[#e5242a]" />
        ...
        <div className="mt-3 flex items-center gap-2.5 rounded-xl bg-[#f6f5f2] px-4 py-3.5">
          <span className="size-2 shrink-0 rounded bg-[#e5242a]" />
  ...
  return (
    <div className="flex h-full w-full items-center justify-center rounded-2xl bg-gradient-to-br from-[#eceae5] to-[#dedcd6] p-6 ring-1 ring-black/[0.04]">
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-6 rounded-lg bg-[#f6f5f2] px-3 py-2">
          <span className="text-xs text-[#888]">Profile saved</span>
          <span className="font-mono text-[11px] text-[#444]">14:32:01</span>
        </div>
        <div className="flex items-center justify-between gap-6 rounded-lg bg-[#f6f5f2] px-3 py-2">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {["Instant URL", "Custom domain", "No expiry", "SEO-friendly"].map(
                (p) => (
                  <span
                    key={p}
                    className="rounded-full bg-[#f6f5f2] px-3.5 py-1.5 text-xs font-medium text-[#0a0a0a]"
                  >
                    {p}
                  </span>
                )
