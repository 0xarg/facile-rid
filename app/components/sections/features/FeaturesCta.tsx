...
const BRAND_GRADIENT =
  "linear-gradient(150deg, #ff8a8d 0%, #ff5b5f 50%, #e5242a 100%)";
  ...
  return (
    <section className="relative overflow-hidden bg-[#ffffff] py-28">
      ...
      >
        <Reveal>
          <div className="mb-12 flex justify-center">
            <Float amount={12} duration={7}>
              <Tilt
                max={10}
                className="relative aspect-square w-[300px] overflow-hidden rounded-[28px] bg-gradient-to-br from-[#ececea] to-[#ececea] ring-1 ring-black/[0.08]"
              >
                <Media
                  src="/images/card.png"
        ...
        <Reveal delay={0.05}>
          <h2 className="font-display text-balance text-5xl font-extrabold leading-[1.02] tracking-tight text-[#0a0a0a] sm:text-6xl md:text-[68px]">
            Make your first
            <br />
            impression count.
          </h2>
