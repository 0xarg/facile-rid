    ...
    <section className="relative overflow-hidden bg-background pb-20 pt-28 sm:pt-32">
      ...
      >
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          <Reveal>
            <span
              className="inline-flex items-center rounded-full px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#0a0a0a]"
          ...
          <Float amount={12} duration={7}>
            ...
            >
              ...
              <div className="pointer-events-none absolute bottom-5 left-5 rounded-2xl bg-black/70 px-4 py-3 backdrop-blur-md">
                <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#0a0a0a]/60">
                  Tap to share
                </p>
                <p className="font-mono text-sm text-[#0a0a0a]">facile.me/you</p>
              </div>
            </Tilt>
          </Float>
        </Reveal>
