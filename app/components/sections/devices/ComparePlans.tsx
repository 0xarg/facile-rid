...
function CheckMark() {
  return (
    <span className="mx-auto flex size-6 items-center justify-center rounded-full bg-panel-foreground text-[#0a0a0a]">
      <svg
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
                  ...
                  {PLANS.map((plan) => (
                    ...
                    >
                      <div className="flex flex-col items-center">
                        {plan.featured ? (
                          <span className="mb-2 rounded-full bg-panel-foreground px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-[#0a0a0a]">
                            Most popular
                          </span>
                        ) : null}
